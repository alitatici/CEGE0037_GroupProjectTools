...
with tab1:
    st.title("Tool 1")
    st.write("You can use this tool for addressing the first goal of the assessment.")
...
with tab2:
    st.title("Tool 2")
    st.write("You can use this tool for addressing the second goal of the assessment.")
